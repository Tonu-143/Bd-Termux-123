...
sys.stdout.write(f'\x1b[1;35m\x1b]2; ★ SCRIPT BY TONU ★\x07')
...
Moch Aang Ardiansyah XD"""
		...
		tod_.add(f"{b}https://www.facebook.com/SADHARON.USER.143{q}")
		tod_.add(f"{b}https://www.facebook.com/groups/672751520627850/?ref=share{q}")
...
class Main_:
	...
	def __check_status_(self, mainx):
		...
		if mainx == mainz:
			...
			kotak("# MAAF SEVER BD-TERMUX SEDANG MAINTENANCE, KAMI AKAN KEMBALI :D",C,K)
			os.system('git pull')
			os.sys.exit()
	def _no_vpn(self):
#		try:
